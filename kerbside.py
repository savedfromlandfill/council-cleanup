...
formdata = {"suburb":"","form_id":"webform_submission_kerbside_collection_search_node_28246_add_form"}
...
for suburb in suburbs:
    if suburb.text[0] != '-':
        ...
        kdate = datetime.strptime(soup.text.replace("Collection starts week commencing:","").replace("\n","").strip(), '%d %B %Y')
